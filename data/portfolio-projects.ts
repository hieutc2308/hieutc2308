...
export const portfolioProjects: Record<string, PortfolioProject> = {
  "healthtech-clinic-analytics": {
    ...
    folderPath: "portfolio-projects/healthtech-clinic-analytics",
    documents: [
      {
  ...
  "powerbi-admin-monitoring": {
    ...
    folderPath: "portfolio-projects/powerbi-admin-monitoring",
    documents: [
      {
        label: "Project workspace",
        type: "Folder",
  ...
  "fashion-retail-analytics": {
    ...
    folderPath: "portfolio-projects/fashion-retail-analytics",
    documents: [
      {
        label: "Project workspace",
        type: "Folder",
  ...
  "bpo-workforce-analytics": {
    ...
    folderPath: "portfolio-projects/bpo-workforce-analytics",
    documents: [
      {
        label: "Project workspace",
        type: "Folder",
  ...
  "employee-turnover-analysis": {
    ...
    folderPath: "portfolio-projects/employee-turnover-analysis",
    documents: [
      {
        label: "Project workspace",
        type: "Folder",
